...
// // 📥 Load signatures
// try {
//   // const raw = fs.readFileSync("./signatures.json", "utf-8");
...
// //       const result = scanLocalFiles(repoPath);
...
// //   return (
// //     file.type === "blob" &&
// //     !IGNORE.some(dir => file.path.includes(dir)) &&
// //     ALLOWED_EXT.some(ext => file.path.endsWith(ext)) &&
// //     file.size < 100000
// //   );
// // }
...
// //     if (stat.isDirectory()) {
// //       if (!IGNORE.some(d => full.includes(d))) {
// //         results = results.concat(getAllFiles(full));
// //       }
// //     } else {
// //       if (ALLOWED_EXT.some(ext => full.endsWith(ext))) {
// //         results.push(full);
// //       }
// //     }
// //   });
